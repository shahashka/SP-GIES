...
run_from_file_gies(dataset_path, NULL, NULL, save_path="../regulondb/obs_md_10_", max_degree=10)
...
# iv_data = dataset[targets.index>1]
#
...
#
# obs_data=dataset
# run_igsp_obs_iv(obs_data, iv_data, save_path="../insilico_size10_3/")
# run_igsp_obs_iv(obs_data, iv_data, save_path="../insilico_size10_3/obs_", obs_only=TRUE)
#
#
...
#
#         obs_data=dataset
#         igsp(obs_data, iv_data, save_path="../insilico_size10_3/")
#         igsp(obs_data, iv_data, save_path="../insilico_size10_3/obs_", obs_only=TRUE)
#     }
# }